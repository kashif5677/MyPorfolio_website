    ...
    className='min-h-screen w-full flex items-center relative bg-black text-white overflow-hidden'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12'>
            ...
            <div className='flex-1 flex flex-col justify-center text-center md:text-left'>
              ...
              <div>
                <div className='mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start '>
                  <a href="#projects" className='inline-flex itmes-center justify-center rounded-lg bg-white text-black font-semibold px-5 py-3 hover:bg-gray-200'>View Project</a>
                  <a href="#contact" className='inline-flex items-center justify-center rounded-lg border border-white/20 text-white px-5 py-3 hover:bg-white/20 transition'>Get intouch</a>
                </div>
              </div>
            </div>
          ...
          >
              ...
              <p className='text-gary-300 leading-related text-base sm:text-lg'>
                I am a Full stack developer with a strong focus on user experience.My toolkit spans the full stack, encompassing both front-end and back-end technologies.
              </p>
          </motion.div>
        </div>
    </section>
